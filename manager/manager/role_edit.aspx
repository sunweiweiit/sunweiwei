<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="manager.role_edit" %>
             ...
             <table style="margin:50px auto auto auto">
                    <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <asp:TextBox ID="roleid" runat="server" Height="20px" Enabled="False" ></asp:TextBox>                              
                            </td>
                        </tr>      
                        <tr>
