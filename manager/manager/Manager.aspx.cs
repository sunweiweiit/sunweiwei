    ...
    public partial class Manager : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    string sql = "select  user_id,user_name,real_name,user_key,user_role,phone,SUBSTRING(CONVERT(CHAR(19), add_time, 120),1,16) as add_time,type from Manager_management";
        ...
        protected void select_Click(object sender, EventArgs e)
        {
            if (selectbox.Text != "")
            {
                ...
                {
                    string sql2 = "select user_id,user_name,real_name,user_key,user_role,phone,SUBSTRING(CONVERT(CHAR(19), add_time, 120),1,16) as add_time,type from Manager_management where user_name = '" + selectbox.Text + "'";
        ...
        protected void del_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow rowview in GridView1.Rows)
            {
...

                {
                    ...
                    {
                        string del = "delete from Manager_management where user_id='" + myid + "'";
