<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="manager.Add" %>
        ...
        <div>
            <div style="margin-top:90px">
                <hr style="height:1px;border:none;border-top:1px solid #555555;" />
                 <div class="hr-more">添加人员</div>
            </div>
             <table style="margin:50px auto auto auto">
                    <tbody>
                          <tr>
                            <th scope="row" class="auto-style2">管理角色</th>
                            <td class="auto-style3">
                                <asp:DropDownList ID="role" runat="server">
                                    <asp:ListItem>请选择角色</asp:ListItem>
                                    <asp:ListItem>演示用户组</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="请选择角色" ControlToValidate="role" ForeColor="Red" MaximumValue="演示用户组" MinimumValue="演示用户组">请选择角色</asp:RangeValidator>
                            </td>
                        </tr>        
                         <tr>
                           ...
                           <tr>
                            <th scope="row" class="auto-style2">用户编号</th>
                            <td class="auto-style3">
                                <asp:TextBox ID="uid" runat="server" ></asp:TextBox>                               
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="编号不能为空" ControlToValidate="uid" ForeColor="Red" >编号不能为空</asp:RequiredFieldValidator>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Label ID="Label1" runat="server" Text="* 字母、数字，不可修改" ForeColor="#CCCCCC"></asp:Label>
                        ...
                        <tr>
                            <th scope="row" class="auto-style2">确认密码</th>
                            <td class="auto-style3">
                                <asp:TextBox ID="rpwd" runat="server">
                                </asp:TextBox>                               
                      ...
                      <%--  <tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tel" runat="server" MaxLength="11"></asp:TextBox>
                      ...
                      <tr>
                            ...
                            <td>  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="邮箱格式错误" ForeColor="Red" ControlToValidate="mail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" SetFocusOnError="True">邮箱格式错误</asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <th scope="row" class="auto-style1">&nbsp;</th>
                            <td>
